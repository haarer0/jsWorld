var Class = (function () {
    ...
    function Class(definition) {
        ...
        if ($extend) {
        	if (definition.extend instanceof Array) {
        		for (var elementIndex in definition.extend) {
        			extend.call(Class.prototype = create(definition.extend[elementIndex].prototype), definition);
        		}
        	} else {
    ...
    function extend(__proto__) {
        for (var key in __proto__) {
        	if (__proto__[key] instanceof Array) {
        		for (var elementIndex in __proto__[key]) {        			
		            if (hasOwnProperty.call(__proto__[key][elementIndex], key)) {
